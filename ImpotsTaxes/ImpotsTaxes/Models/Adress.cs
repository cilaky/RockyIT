   ...
   public class Adress
    {
       public int nbre { get; set; }
        ...
        /*public void modify_prov(string pProvAnc, string pProvNouv)
        {
            DBConnection con = new DBConnection();
            con.Execute_Query("UPDATE province SET prov='" + pProvNouv + "' WHERE prov='" + pProvAnc + "'");
        }*/

       /* public void modify_town_district(string pProv, string ptown_dist, string ptown_distOld)
        {
            DBConnection con = new DBConnection();
            con.Execute_Query("UPDATE town_district SET town_dist='" + ptown_dist + "' WHERE town_dist='" + ptown_distOld + "' and prov='" + pProv + "'");
        }*/
